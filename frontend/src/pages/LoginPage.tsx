...
const roles = [
  { id: 'sherlock' as const, label: 'Sherlock', desc: 'Field Volunteer', icon: <Search className="w-5 h-5" />, color: 'from-orange-500 to-amber-500', ring: 'ring-orange-500' },
  { id: 'police' as const, label: 'Police', desc: 'Control Room', icon: <Shield className="w-5 h-5" />, color: 'from-blue-500 to-indigo-600', ring: 'ring-blue-500' },
  { id: 'admin' as const, label: 'Central', desc: 'Command Center', icon: <Radio className="w-5 h-5" />, color: 'from-purple-500 to-fuchsia-600', ring: 'ring-purple-500' },
];
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-blue-600/10 to-transparent rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Kumbh Mela 2027</h1>
          <p className="text-sm text-gray-500 mt-1">Missing Person Response System</p>
          <p className="text-xs text-gray-600 mt-0.5">Nashik-Trimbakeshwar Simhastha</p>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl shadow-black/50 p-6">
          ...
          <div className="mt-5 pt-4 border-t border-gray-800">
            <p className="text-[10px] uppercase tracking-wider text-gray-600 mb-2 text-center">Test Credentials</p>
